 ...
 *
 * Un SimpleAsynchConsumer � un endpoint per ricevere messaggi
 * da una generica destinazione JMS (coda o argomento).
 * 
 * La ricezione dei messaggi avviene secondo la modalit� asincrona.
 *
...
public class SimpleAsynchConsumer implements Cancellable {
    ...
    public void receiveMessages() {
        try {
            ...
            /* � stato fermato, arresta la consegna di messaggi per la connessione */
            connection.stop();
        } catch (JMSException e) {
    ...
    /**
     * Questo consumer � stato cancellato?
     */
